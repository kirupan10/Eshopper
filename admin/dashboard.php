          ...
          <div class="main-content-container container-fluid px-4">
            ...
            <div class="page-header row no-gutters py-4">
              <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title">Quick Overview</h3>
              </div>
            </div>
            <!-- End Page Header -->
<?php $rt=mysqli_query($con,"select * from products");
$num=mysqli_num_rows($rt);{
}
?>
<?php $customer=mysqli_query($con,"select * from users");
$customer_num=mysqli_num_rows($customer);{
}
?>
<?php $orders=mysqli_query($con,"select * from orders");
$orders_num=mysqli_num_rows($orders);{
}
?>
<?php $review=mysqli_query($con,"select * from productreviews");
$review_num=mysqli_num_rows($review);{
}
?>
<?php $admin=mysqli_query($con,"select * from admin");
                  ...
                  <div class="card-body p-0 d-flex">
                    <div class="d-flex flex-column m-auto">
                      <div class="stats-small__data text-center">
                        ...
                        <h6 class="stats-small__value count my-3"><?php echo $customer_num; ?></h6>
                      </div>
                  ...
                  <div class="card-body p-0 d-flex">
                    <div class="d-flex flex-column m-auto">
                      <div class="stats-small__data text-center">
                        ...
                        <h6 class="stats-small__value count my-3"><?php echo $orders_num; ?></h6>
                      </div>
                      <div class="stats-small__data">
                  ...
                  <div class="card-body p-0 d-flex">
                    <div class="d-flex flex-column m-auto">
                      <div class="stats-small__data text-center">
                        ...
                        <h6 class="stats-small__value count my-3"><?php echo $num; ?></h6>
                      </div>
                      <div class="stats-small__data">
              ...
              <div class="col-lg col-md-4 col-sm-6 mb-4">
                <div class="stats-small stats-small--1 card card-small">
                  <div class="card-body p-0 d-flex">
                    <div class="d-flex flex-column m-auto">
                      <div class="stats-small__data text-center">
                        <span class="stats-small__label text-uppercase">Product Reviews</span>
                        <h6 class="stats-small__value count my-3"><?php echo $review_num; ?></h6>
                      </div>
                      <div class="stats-small__data">
                        <span class="stats-small__percentage stats-small__percentage--increase">12.4%</span>
                      </div>
                  ...
                  <div class="card-body p-0 d-flex">
                    <div class="d-flex flex-column m-auto">
                      <div class="stats-small__data text-center">
                        ...
                        <h6 class="stats-small__value count my-3"><?php echo $admin_num; ?></h6>
                      </div>
                      <div class="stats-small__data">
...
<?php
$number = 1;
$message=mysqli_query($con,"select * from messages ORDER BY id DESC limit 3");
while($row=mysqli_fetch_array($message))
{?>				  
                  <div class="card-body p-0">
                    <div class="blog-comments__item d-flex p-3">
                      <div class="blog-comments__avatar mr-3">
                        <img src="images/avatars/<?php echo $number ;?>.jpg" alt="User avatar" /> </div>
                      <div class="blog-comments__content">
                        <div class="blog-comments__meta text-muted">
                          <a class="text-secondary" href="#"><?php echo htmlentities($row['name']);?></a> on
                          <a class="text-secondary" href="#"><?php echo htmlentities($row['email']);?></a><br>
                          <span class="text-muted">– <?php echo htmlentities($row['creation']);?></span>
                        </div>
                        <p class="m-0 my-1 mb-2 text-muted"><?php echo htmlentities($row['message']);?></p>
...
?>
<?php $rt=mysqli_query($con,"select * from products where category= '$number'");
$num=mysqli_num_rows($rt);{
}
?>
                    ...
                    <ul class="list-group list-group-small list-group-flush">
                      <li class="list-group-item d-flex px-3">
                        <span class="text-semibold text-fiord-blue"><?php echo htmlentities($row['categoryName']);?></span>
                        <span class="ml-auto text-right text-semibold text-reagent-gray"><?php echo $num; ?></span>
                      </li>
                    </ul>
<?php $number = $number+1; }?>
                  </div>
                  <div class="card-footer border-top">
                    <div class="row">
                      ...
                      <div class="col text-right view-report">
                        <a href="products">Full report &rarr;</a>
                      </div>
                    </div>
                  </div>
                </div>
