...
header('location:/eshopper/admin');
	...
	if(isset($_POST['Update'])){
		...
		if($newpass!=$confirmpass){
			...
			$query=mysqli_query($con,"update admin set password='$newpass'where id='".$_SESSION['id']."'");
			if($query){
                        ...
                        <div class="col">
                          <form action="" method="POST">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="feInputAddress" placeholder="Seirra Rossi" value="<?php echo htmlentities($row['name']);?>" readonly> </div>
                            
							<div class="form-group">
                              <label for="feInputAddress">Email</label>
                              <input type="email" class="form-control" id="feInputAddress" placeholder="Seirra Rossi" value="<?php echo htmlentities($row['username']);?>" readonly> </div>
                              
                            
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                <label for="fePassword">New-Password</label>
                                <input type="text" class="form-control" id="fePassword" name="newpass" placeholder="New-Password"> </div>
                            <div class="form-group col-md-6">
                                <label for="fePassword">Confirm-Password</label>
                                <input type="text" class="form-control" id="fePassword" name="confirmpass" placeholder="Confirm-Password"> </div>
                            </div>
                            
                            <div class="form-row">
                              <div class="form-group col-md-12">
                                <label for="feDescription">Description</label>
                                <textarea class="form-control" name="feDescription" rows="5">the management of any office, business, or organization; direction. the function of a political state in exercising its governmental duties. the duty or duties of an administrator in exercising the executive functions of the position. the management by an administrator of such duties.</textarea>
                              </div>
                            </div>
