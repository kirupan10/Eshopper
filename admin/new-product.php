...
header('location:/eshopper/admin');
	...
	$log=mysqli_query($con,"insert into products(category,subCategory,productName,productCompany,productPrice,productDescription,shippingCharge,productAvailability) 
	values('$category','$subCategory','$productName','$productCompany','$productPrice','$productDescription','$shippingCharge','$productAvailability')");
	if($log){
		echo "<script>alert('Category has been updated');
			window.location.href='new-product';</script>";
	}else{
		echo("Error description      b          b                    h : " . mysqli_error($con));
	}
                        ...
                        <div class="col">
                          <form action="" method="POST">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="feInputAddress" name="productName" placeholder=""> </div>
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                <label for="feEmailAddress">Product Company</label>
                                <input type="text" class="form-control" id="feEmailAddress" name="productCompany" placeholder=""> </div>
                              <div class="form-group col-md-6">
                                <label for="fePassword">Product Price</label>
                                <input type="text" class="form-control" id="fePassword" placeholder="" name="productPrice"> </div>
                            </div>
                            <div class="form-group">
                              <label for="feInputAddress">Product Description</label>
                              <input type="text" class="form-control" id="feInputAddress" placeholder="" name="productDescription"> </div>
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                <label for="feInputCity">Shipping Charge</label>
                                <input type="text" class="form-control" name="shippingCharge" id="feInputCity"> </div>
...
<?php $number = $number+1; } ?>
							...
							<div class="form-row">
                              <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="feInputCity" name="productAvailability"> </div>
                              <div class="form-group col-md-4">
                            ...
                            <button type="submit" name="new" class="btn btn-accent">Add New Products</button>
