                        ...
                        <div class="col">
                          <form>
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="feInputAddress" placeholder="Seirra Rossi" value="<?php echo htmlentities($row['name']);?>" required"> </div>
                              
                            
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                <label for="feEmailAddress">Email</label>
                                <input type="email" class="form-control" id="feEmailAddress" placeholder="Email" value="<?php echo htmlentities($row['name']);?>" required> </div>
                              <div class="form-group col-md-6">
                                <label for="fePassword">Password</label>
                                <input type="password" class="form-control" id="fePassword" placeholder="Password" value="<?php echo htmlentities($row['name']);?>" required> </div>
                            </div>
                            <div class="form-group">
