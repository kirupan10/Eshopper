...
if(strlen($_SESSION['admin_login'])==0)
	{	
header('location:/eshopper/admin');
}
else{
	if($_GET['pid']){
	$pid = $_GET['pid'];
	...
	$log=mysqli_query($con,"update products SET category =$category ,
	...
	if($log){
		echo "<script>alert('Category has been updated');
			window.location.href='products-view';</script>";
	}else{
        ...
        <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
          ...
          <div class="nav-wrapper">
            <ul class="nav flex-column">
			  ...
			  <li class="nav-item">
                <a class="nav-link active" href="new-product">
                  <i class="material-icons">view_module</i>
...
{?>	                       <div class="col">
                          <form action="" method="POST">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="feInputAddress" name="productName" placeholder="" value="<?php echo htmlentities($row['productName']);?>"> </div>
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                <label for="feEmailAddress">Product Company</label>
                                <input type="text" class="form-control" id="feEmailAddress" name="productCompany" placeholder="" value="<?php echo htmlentities($row['productCompany']);?>"> </div>
                              <div class="form-group col-md-6">
                                <label for="fePassword">Product Price</label>
                                <input type="text" class="form-control" id="fePassword" placeholder="" name="productPrice" value="<?php echo htmlentities($row['productPrice']);?>"> </div>
                            </div>
                            <div class="form-group">
                              <label for="feInputAddress">Product Description</label>
                              <input type="text" class="form-control" id="feInputAddress" placeholder="" name="productDescription" value="<?php echo htmlentities($row['productDescription']);?>"> </div>
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                <label for="feInputCity">Shipping Charge</label>
                                <input type="text" class="form-control" name="shippingCharge" id="feInputCity" value="<?php echo htmlentities($row['shippingCharge']);?>"> </div>
                              <div class="form-group col-md-4">
                                <label for="feInputState">Category</label>
                                <select id="feInputState" class="form-control" name="category">
<?php
$number = 1;
$query1=mysqli_query($con,"select * from category");
while($row1=mysqli_fetch_array($query1))
{?>							  
                                <option value="<?php echo $number;?>"><?php echo htmlentities($row1['categoryName']);?>"</option>
<?php $number = $number+1; } ?>
                                </select>
                              </div>
                              </div>
							<div class="form-row">
                              <div class="form-group col-md-6">
                                <label for="feInputCity">Product Availability</label>
                                <input type="text" class="form-control" id="feInputCity" name="productAvailability" value="<?php echo htmlentities($row['productAvailability']);?>"> </div>
                              <div class="form-group col-md-4">
                                <label for="feInputState">Sub Category</label>
                                <select id="feInputState" class="form-control" name="subCategory">
                            ...
                            <button type="submit" name="Update" class="btn btn-accent">Add New Products</button>
							<button type="submit" name="Delete" class="btn btn-accent">Delete Products</button>
